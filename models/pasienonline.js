...
module.exports = function (sequelize, DataTypes) {
  return sequelize.define(
    "pasienonline",
    {
      ...
      regpsonline_tgl_berkunjung: {
        type: DataTypes.DATEONLY,
        allowNull: true,
      },
      regpsonline_infokerja_lainnya: {
        type: DataTypes.STRING(200),
        allowNull: true,
      },
      regpsonline_disabilitas: {
      ...
      indexes: [
        {
          ...
          unique: true,
          fields: [{ name: "regpsonline_id_reg" }],
        },
      ],
    }
  );
